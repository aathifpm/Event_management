...
RUN ./mvnw dependency:go-offline -B -Pdocker

# Copy the source code
COPY src ./src

# Build the application (use docker profile that skips toolchains plugin)
